...
namespace WardTracker
{
    ...
    internal class DetectedWard
    {
        ...
        public int Duration => WardData.Duration;

        public int EndT => StartT + Duration;

        public Vector3 StartPosition { get; set; }
        public Vector3 Position { get; set; }

        public Color Color => WardData.Color;

        public int Range => WardData.Range;
        ...
        private Vector2 MinimapPosition => Drawing.WorldToMinimap(Position) +
                                           new Vector2(-WardData.Bitmap.Width / 2 * Scale, -WardData.Bitmap.Height / 2 * Scale);
        ...
        public void CreateRenderObjects()
        {
            ...
            if (Range == 1100)
            {
                _minimapSprite = new Render.Sprite(WardData.Bitmap, MinimapPosition) {Scale = new Vector2(Scale, Scale)};
            ...
            _rangeCircle = new Render.Circle(Position, Range, Color, 10);
            ...
            if (IsFromMissile)
            {
                _missileLine = new Render.Line(new Vector2(), new Vector2(), 2, new ColorBGRA(255, 255, 255, 255)) {EndPositionUpdate = () => Drawing.WorldToScreen(Position), StartPositionUpdate = () => Drawing.WorldToScreen(StartPosition)};
            ...
            {
                _timerText = new Render.Text(10, 10, "t", 18, new ColorBGRA(255, 255, 255, 255)) {OutLined = true, PositionUpdate = () => Drawing.WorldToScreen(Position), Centered = true};
    ...
    public static class WardTracker
    {
        ...
        private static void Obj_AI_Base_OnCreate(GameObject sender, EventArgs args)
        {
            ...
            {
                if (string.Equals(
                    wardObject.CharData.BaseSkinName, wardData.ObjectBaseSkinName, StringComparison.InvariantCultureIgnoreCase))
                {
